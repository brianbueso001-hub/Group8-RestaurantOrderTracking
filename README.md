...
# Group Members
Brian Bueso Pierina Flores Matthew Mazuelos
# Project Description
The Restaurant Order Tracking System is a Python based application designed to manage customer order cycles within the restaurant. Restaurants require swift communication between the front staff taking orders and the and the back-of-house staff preparing the orders. This system serves as a text based interface where employees can input new orders, search for specific active tickets, display a comprehensive log of all transactions, and update orders. This system will serve as an automated operation summary to help manage daily performance.
